...
const App = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    navigate(`/edit?room=${room}&username=${username}`)
  }
  ...
  return (
      ...
      <section className="h-screen w-full">
        ...
        <span className="[&>svg]:absolute [&>svg]:-z-10 [&>svg]:m-auto [&>svg]:block [&>svg]:w-full">
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="700"
            ...
            <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
              <linearGradient id="lg-0.047955344060927496" x1="0" x2="1" y1="0" y2="0">
                <stop stop-color="hsl(125, 16%, 59%)" offset="0"></stop>
                <stop stop-color="hsl(125, 16%, 59%)" offset="1"></stop>
              </linearGradient>
        ...
        <div className="sm:max-w-2xl md:max-w-3xl mx-auto h-full ">
          <div className="text-center h-full">
            <div className="center-column h-full w-full"  style={{position: "relative", "top": "50%", "left": "50%", transform:" translate(-50%, -50%)"}}>
                <img className="logo" src="logo.svg" width="300px" alt="codpen Logo" />
                <p className="description ">Experience the power of creativity and teamwork with our CodePen-inspired platform, where multiple users can seamlessly collaborate on coding projects in real-time. Welcome to the future of coding collaboration!</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col">
                    <div className="relative mb-3" data-te-input-wrapper-init>
                        <input
                          ...
                          className="peer block min-h-[auto] w-full rounded border-0 bg-[#ADBC9F] px-8 py-[0.8rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none  [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                          id="exampleFormControlInputText"
                          placeholder="Example label" />
                        <label
                          htmlFor="exampleFormControlInputText"
                          className="pointer-events-none absolute left-3 top-2 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6]  transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none "
                          >UserName
                        </label>
                    </div>
                    <div className="relative mb-3" data-te-input-wrapper-init>
                        ...
                        <div className="m-3">
                          <button
                            className="w-6/7 bg-white tracking-wide text-gray-800 font-bold rounded border-b-2 border-[#ADBC9F] hover:border-[#ADBC9F] hover:bg-[#ADBC9F] hover:text-white shadow-md py-2 px-6 inline-flex items-center">
                            <span className="mx-auto">Start coding🧑‍💻</span>
                          </button>
                        </div>
                  </form>
            </div>
